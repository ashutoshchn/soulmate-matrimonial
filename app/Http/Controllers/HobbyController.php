     ...
     */
     public function update(Request $request, $id)
     {
         ...
         if($hobbies->save()){
             ...
             AdminNotificationUtility::send_profileupdate_admin_notification(translate('Hobby and Interests info'));

            return redirect()->to(url()->previous() . '#hobbies');
         }
         else {
             flash(translate('Sorry! Something went wrong with Hobby and interests info.'))->error();
             return redirect()->to(url()->previous() . '#hobbies');
         }
