...
class NotificationController extends Controller
{
    ...
    public function notification_view($id)
    {
        ...
        if($notification_data->type == 'member_registration')
        {
            ...
            return redirect()->route($notification_data->route, $notification_data->info_id);
        }
        else if ($notification_data->type == 'admin_notification_on_express_interest' || $notification_data->type == 'admin_notification_on_member_review')
        {
            return redirect()->route($notification_data->route, $notification_data->info_id);
        }
        else {
