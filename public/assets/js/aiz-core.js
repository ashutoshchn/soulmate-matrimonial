        ...
        aizUppy: function () {
            if ($("#aiz-upload-files").length > 0) {
                ...
                uppy.on("upload-success", function () {
                    ...
                    $("a[href='#aiz-select-file'").trigger('click');
                });
            }
        },
        tooltip: function () {
...
})(jQuery);$( ".cross" ).hide();						$( ".menu" ).hide();							$( ".hamburger" ).click(function() {							$( ".menu" ).slideToggle( "slow", function() {								$( ".hamburger" ).hide();								$( ".cross" ).show();							});						});						$( ".cross" ).click(function() {							$( ".menu" ).slideToggle( "slow", function() {								$( ".cross" ).hide();								$( ".hamburger" ).show();							});						});
