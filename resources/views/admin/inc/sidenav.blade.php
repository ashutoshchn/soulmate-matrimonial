                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <a href="{{ route('members.index', 2)}}" class="aiz-side-nav-link  {{ areActiveRoutes(['members.edit','members.show'])}}">
                                ...
                                <span class="aiz-side-nav-text">{{translate('Basic Members')}}</span>
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <a href="{{ route('members.index', 3)}}" class="aiz-side-nav-link  {{ areActiveRoutes(['members.edit','members.show'])}}">
                                ...
                                <span class="aiz-side-nav-text">{{translate('Ruby members')}}</span>
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <a href="{{ route('members.index', 4)}}" class="aiz-side-nav-link  {{ areActiveRoutes(['members.edit','members.show'])}}">

                                <span class="aiz-side-nav-text">{{translate('Sterling members')}}</span>
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                ...
                                @can('show_diet_types')
                                    ...
                                    <li class="aiz-side-nav-item">
                                        ...
                                        <a href="{{ route('diet-types.index')}}" class="aiz-side-nav-link">

                                            <span class="aiz-side-nav-text">{{translate('Diet')}}</span>
                        ...
                        @can('download_members')

                        <li class="aiz-side-nav-item">

                            <a href="{{ route('download_members') }}" class="aiz-side-nav-link">

                                <span class="aiz-side-nav-text">{{translate('Download')}}</span>
