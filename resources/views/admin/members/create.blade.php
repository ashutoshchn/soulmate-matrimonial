            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('members.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label" for="signinSrEmail">{{translate('photo')}} <small>(800x800)</small> <small>Accepted file types: jpg, jpeg, png, svg, webp, gif</small></label>
                            <div class="col-md-9">
