...
@php
    ...
    {
        $interest_onclick  = 0;
        $interest_text     = !empty($do_expressed_interest) && $do_expressed_interest->status == 0 ? translate('Interest Expressed') : translate('Interest Accepted');
    }

    if(!empty($do_expressed_interest) || !empty($received_expressed_interest))
    {
    $interest_accepted = ((!empty($do_expressed_interest) && $do_expressed_interest->status == 1) || (!empty($received_expressed_interest) && $received_expressed_interest->status == 1)) ? true : false;
    }
    else{
    $interest_accepted = false;
    }

    $member11 = \App\Models\Member::where('user_id', Auth::user()->id)->first();
    $member22 = \App\Models\Member::where('user_id',$user->id)->first();
    $upgradedMem=$member11->current_package_id < $member22->current_package_id;
    if($upgradedMem)
    {
        $package = \App\Models\Package::where('id', $member22->current_package_id)->first();
        $msg111='Please upgrade your package to '.$package->name.' to send interest to this member.';
    }
                ...
                <div class="px-3 row align-items-center">
                    <div class="col-md-8 col-xxl-9">
                        <h1 class="fs-24 fw-600">
                          {{ $interest_accepted==true ? $user->first_name.' '.$user->last_name : '' }} 
                            ...
                            <tbody>
                                <tr>
                                    <td width="50%">
                                        ...
                                        {{ translate('yrs') }}
                                        {{ !empty($user->physical_attributes->height) ? ', '.number_format((float)$user->physical_attributes->height, 2, '.', '') : "" }}
                                    </td>
                                    <td width="50%">
                    ...
                    <div class="col-md-4 col-xxl-3">
                        ...
                        <div class="py-4 text-center border-md-left border-gray-600">
                            ...
                            @endif
                              ...
                              <a
                                @if($upgradedMem)
                                    onclick="upgrade_package('{{ $msg111 }}');"
            ...
            <div class="col-xl-4 col-xxl-3 order-1 order-xl-0">
                <div class="aiz-profile-sidebar">
                    ...
                    <div class="mb-4 p-4 border rounded border-gray-200 d-none d-xl-block">
                        ...
                        <h2 class="fs-20 fw-500 mb-4">{{ $interest_accepted==true ? $user->first_name.' '.$user->last_name : '' }}</h2>
                        <div class="mb-2">
                            @php
                              ...
                              @foreach ($similar_profiles->shuffle()->take(4) as $similar_profile)
                                @if($similar_profile->matched_profile != null)
                                  <a href="{{ route('member_profile', $similar_profile->match_id) }}" class="text-reset border rounded row no-gutters align-items-center mb-3">
                                      ...
                                      <div class="col">
                                        <div class="p-3">
                                            <h5 class="fs-16 text-body text-truncate">{{translate('Member Id:'). $similar_profile->matched_profile->code }}</h5>
                                            <div class="fs-12 text-truncate-3">
                                                ...
                                                <span class="mr-1 d-inline-block">
                                                  @if(!empty($similar_profile->matched_profile->physical_attributes->height))
                                                    {{ number_format((float)$similar_profile->matched_profile->physical_attributes->height, 2, '.', '') }} {{ translate('Feet') }},
                                                  @endif
                                                </span>
                                                <span class="mr-1 d-inline-block">
                        ...
                        <div class="accordion aiz-timeline-accordion" id="profile-accordion">
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                    ...
                                    <div class="ml-4">
                                        <span
                                            class="fs-18 fw-600 d-block">{{ translate('About Member') }}</span>
                                                ...
                                                <table class="w-100 ml-sm-4">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="py-1">{{ !empty($user->recidency->immigration_status) ? translate($user->recidency->immigration_status) : "" }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                            ...
                            @endif
                            @if(get_setting('member_present_address_section') == 'on' && $interest_accepted==true)
                            <!-- Present Address -->
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                            ...
                            @endif
                            @if(get_setting('member_permanent_address_section') == 'on' && $interest_accepted==true)
                            <!-- Permanent Address -->
                            <div class="pb-4 accordion-item">
                                                ...
                                                <table class="w-100">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="py-1">@if(!empty($user->lifestyles->diet))
                                                                {{ optional(\App\Models\DietType::where('id',$user->lifestyles->diet)->first())->name }}
                                                                @endif</td>
                                                            
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1">{{translate('Smoke')}}</th>
                                                            <td class="py-1">{{ !empty($user->lifestyles->smoke) ? translate($user->lifestyles->smoke) : "" }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <table class="w-100 ml-sm-4">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="py-1">{{ !empty($user->lifestyles->drink) ? translate($user->lifestyles->drink) : "" }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-1">{{translate('Living With')}}</th>
                                                            <td class="py-1">{{ !empty($user->lifestyles->living_with) ? translate($user->lifestyles->living_with) : "" }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <table class="w-100">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th class="py-1">{{translate('Manglik')}}</th>
                                                            <td class="py-1">{{ !empty($user->astrologies->manglik) ? translate($user->astrologies->manglik) : "" }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                            ...
                            @endif
                            @if(get_setting('member_family_information_section') == 'on'  && $interest_accepted==true)
                            <!-- Family Information -->
                            <div class="pb-4 accordion-item">
                        ...
                        <div class="">
                              <table class="table table-responsive">
                                  <tr>
                                      ...
                                      <td>
                                          @php
                                          $residence_country = !empty($user->partner_expectations->residence_country_id) && $user->partner_expectations->residence_country_id == 0  ?
                                  ...
                                  <tr>
                                      ...
                                      <td> @if(!empty($user->partner_expectations->language_id))
                                         {{ optional(\App\Models\MemberLanguage::where('id',$user->partner_expectations->language_id)->first())->name }}
                                                                @endif
                                      </td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                      ...
                                      <td>@if(!empty($user->partner_expectations->diet))
                                         {{ optional(\App\Models\DietType::where('id',$user->partner_expectations->diet)->first())->name }}
                                                                @endif
                                  ...
                                  <tr>
                                      ...
                                      <td>{{ !empty($user->partner_expectations->manglik) ? translate($user->partner_expectations->manglik) : "" }}
                                      </td>
                                  </tr>
                                  <tr>
...
@section('modal')
    ...
    @include('modals.package_update_alert_modal1')
...
<script type="text/javascript">
    ...
    function upgrade_package(msg)
    {
        $('#msg1122').text(msg);
        $('.package_update_alert_modal1').modal('show');
    }
