<div class="card">
    ...
    <div class="card-body">
      <form action="{{ route('physical-attribute.update_new', $member->id) }}" method="POST" id="regForm-9">
          ...
          <div class="col-md-6">
                  ...
                  @php $member_height = !empty($member->physical_attributes->height) ? number_format((float)$member->physical_attributes->height, 2, '.', '')
                   : ""; @endphp
