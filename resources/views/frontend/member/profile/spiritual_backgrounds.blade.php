      ...
      <form action="{{ route('spiritual_backgrounds.update', $member->id) }}" method="POST">
          ...
          <div class="form-group row">
              ...
              <div class="col-md-6">
                  ...
                  <input type="text" name="family_value" value="{{!empty($member->spiritual_backgrounds->family_value) ? $member->spiritual_backgrounds->family_value : "" }}" class="form-control" placeholder="{{translate('Family Value')}}">
