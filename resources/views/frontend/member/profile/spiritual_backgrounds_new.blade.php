<div class="card">
    ...
    <div class="card-body">
      <form action="{{ route('spiritual_backgrounds.update_new', $member->id) }}" method="POST" id="regForm-12"> 
          ...
          <div class="form-group row">
              ...
              <div class="col-md-6">
                  ...
                  <input type="text" name="ethnicity" value="{{!empty($member->spiritual_backgrounds->ethnicity) ? $member->spiritual_backgrounds->ethnicity : "" }}" class="form-control" placeholder="{{translate('Please specify your Ethnicity')}}">
                  @error('ethnicity')
                      <small class="form-text text-danger">{{ $message }}</small>
                  @enderror
              </div>
          ...
          <div class="form-group row">
              ...
              <div class="col-md-6">
                  ...
                  <input type="text" name="family_value" value="{{!empty($member->spiritual_backgrounds->family_value) ? $member->spiritual_backgrounds->family_value : "" }}" class="form-control" placeholder="{{translate('Please specify your Family Value')}}">
