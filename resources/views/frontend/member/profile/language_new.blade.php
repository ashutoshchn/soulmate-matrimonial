<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('member.language_info_update_new', $member->id) }}" method="POST" id="regForm-10">
            @csrf
            <div class="form-group row">
                <div class="col-md-6">
                    <label for="diet">{{translate('Mothere Tongue')}}</label>
                    <span class="text-danger">*</span>
                    <select class="form-control aiz-selectpicker" name="mothere_tongue" data-live-search="true" required>
