<form action="{{ route('career.store_new') }}" method="POST">
    @csrf
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" name="company" placeholder="{{ translate('Company Name') }}" class="form-control" required>
            </div>
        </div>
        <!-- <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="number" name="career_end"  placeholder="{{ translate('End') }}" class="form-control" required>
            </div>
        </div> -->
    </div>
