    ...
    <div class="row gutters-5">
        <div class="col-md-4 mx-auto mb-3" >
            <div class="bg-light rounded overflow-hidden text-center p-3">
                ...
                @if ($user->member->package->id == 4)
                  <div class="h4 fw-700 text-primary-grad">{{ get_remaining_value($user->id,'remaining_interest') }} ({{ translate("Unlimited") }})</div>
				        @else
        ...
        <div class="col-md-4 mx-auto mb-3" >
            <div class="bg-light rounded overflow-hidden text-center p-3">
                ...
                @if ($user->member->package->id == 4)
                  <div class="h4 fw-700 text-primary-grad">{{ get_remaining_value($user->id,'remaining_contact_view') }} ({{ translate("Unlimited") }})</div>
				        @else
