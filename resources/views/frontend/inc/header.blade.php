<div class="@if(get_setting('header_stikcy') == 'on') position-fixed @else position-absolute @endif w-100 top-0 z-1020 aiz-header">
    <div class="top-navbar z-1035 py-2 d-lg-block">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 col">
                    <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0">
                        <li class="list-inline-item">
                          <a href="{{ get_setting('header_left_quick_link1') }}" class="">
                ...
                <div class="col-lg-7 col">
                    <ul class="list-inline mb-0 d-flex align-items-center justify-content-end ">
                        ...
                        <span>Preeti +61404316288 </span><br /> <span>Heena +61416787526</span>
    ...
    <header
        class="shadow-md border-gray-300">
            ...
            <div class="container">
                <div class="d-lg-flex justify-content-between text-center text-lg-left">
                    ...
                    <ul>
                        ...
                        <li class="{{ areActiveRoutes(['profile_settings'],'') }}">
                        <a href="{{ route('profile_settings') }}">{{ translate('My Profile') }}</a>
                        </li>
                        <li class="{{ areActiveRoutes(['express-interest.index'],'') }}">
                        <a href="{{ route('express-interest.index') }}">{{ translate('My Interest') }}</a>
                        </li>
                        <li class="{{ areActiveRoutes(['my_shortlists'],'') }}">
                        <a href="{{ route('my_shortlists') }}">{{ translate('Shortlist') }}</a>
                        </li>
                        <li class="{{ areActiveRoutes(['all.messages'],'') }}">
                        <a href="{{ route('all.messages') }}">{{ translate('Messaging') }}</a>
                        </li>
                        <li class="{{ areActiveRoutes(['my_ignored_list'],'') }}">
                        <a href="{{ route('my_ignored_list') }}">{{ translate('Ignored User List') }}</a>
                        </li>
                    @endif
        ...
        <div class="border-top d-none d-lg-block">
            <div class="container">
                <ul class="list-inline d-flex align-items-center mb-0" style="color: white!important">
                    <li class="list-inline-item">
                        <a href="{{ route('dashboard') }}"
                            class="text-reset d-inline-block px-4 py-3 fw-600 {{ areActiveRoutes(['dashboard'],'opacity-100') }}">
                    ...
                    <li class="list-inline-item">
                        <a href="{{ route('profile_settings') }}"
                            class="text-reset d-inline-block px-4 py-3 fw-600 {{ areActiveRoutes(['profile_settings'],'opacity-100') }}">
                    ...
                    <li class="list-inline-item">
                        <a href="{{ route('my_interests.index') }}"
                            class="text-reset d-inline-block px-4 py-3 fw-600 {{ areActiveRoutes(['express-interest.index'],'opacity-100') }}">
                    ...
                    <li class="list-inline-item">
                        <a href="{{route('my_shortlists')}}"
                            class="text-reset d-inline-block px-4 py-3 fw-600 {{ areActiveRoutes(['my_shortlists'],'opacity-100') }}">
                    ...
                    <li class="list-inline-item">
                        <a href="{{ route('all.messages') }}"
                            class="text-reset d-inline-block px-4 py-3 fw-600 {{ areActiveRoutes(['all.messages'],'opacity-100') }}">
                    ...
                    <li class="list-inline-item">
                        <a href="{{ route('my_ignored_list') }}"
                            class="text-reset d-inline-block px-4 py-3 fw-600 {{ areActiveRoutes(['my_ignored_list'],'opacity-100') }}">
