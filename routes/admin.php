...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/members/member_list/{id}','MemberController@index1')->name('members.index');
    ...
    Route::get('/download_members','MemberController@download_members')->name('download_members');
    Route::get('/download_members_data','MemberController@download_members_data')->name('download_members_data');
    ...
    // Member profile attributes
        ...
        Route::resource('diet-types','DietTypeController');
        Route::get('/diet-types/destroy/{id}','DietTypeController@destroy')->name('diet-types.destroy');
    ...
    Route::get('/cleareverything3', function () {
